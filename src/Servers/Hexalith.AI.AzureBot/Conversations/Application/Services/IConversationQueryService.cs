...
/// <summary>
/// Interface IConversationQueryService.
/// </summary>
public interface IConversationQueryService
{
    /// <summary>
    /// Get conversation text as an asynchronous operation.
    /// </summary>
    /// <param name="id">The identifier.</param>
    /// <param name="cancellationToken">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
    /// <returns>A Task&lt;System.String&gt; representing the asynchronous operation.</returns>
    Task<string> GetConversationTextAsync(string id, CancellationToken cancellationToken);
}